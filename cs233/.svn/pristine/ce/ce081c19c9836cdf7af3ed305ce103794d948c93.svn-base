module palindrome_control_test;
    ...
    circuit.rf.r[15] <=  32'hCAFEBABE;
    circuit.rf.r[16] <=  32'hFFFFFFFF;
    circuit.rf.r[17] <=  32'h0B3D1E55;
    circuit.rf.r[18] <=  32'h0B123E57;
    circuit.rf.r[19] <=  32'h0B3D1E55;
    circuit.rf.r[20] <=  32'hFFFFFFFF;
    circuit.rf.r[21] <=  32'hCAFEBABE;
    # 2 base = 15; ending= 21; go = 1;
    # 20 go = 0;
    	...
    	# 10 base = 11; ending= 14; go = 1;
    	# 20 go = 0;

      # 10 reset = 1;
      # 10 reset = 0;
      // Test an odd length palindrome
      circuit.rf.r[22] <=  32'hCAFEBABE;
      circuit.rf.r[23] <=  32'hFFFFFFFF;
      circuit.rf.r[24] <=  32'h0B3D1E55;
      circuit.rf.r[25] <=  32'h0B3D1E53;
      circuit.rf.r[26] <=  32'h0B3D1E56;
      circuit.rf.r[27] <=  32'h0B3D1E56;
      circuit.rf.r[28] <=  32'h0B3D1E53;
      circuit.rf.r[29] <=  32'h0B3D1E55;
      circuit.rf.r[30] <=  32'hFFFFFFFF;
      circuit.rf.r[31] <=  32'hCAFEBABE;
      # 10 base = 22; ending= 31; go = 1;
      # 20 go = 0;
